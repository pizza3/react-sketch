  ...
  render(){
    ...
    return(
      <div className='navigation'id='nav'>
        ...
        <div className='rainbow' onClick={this.props.rainbow}>
          <span className="hint--bottom hint--rounded " aria-label="HSLA" style={index} ></span>
          <span id='rainbow-span' className='rainbow-span'></span>
        </div>

        <div className='pick' onClick={this.props.action}  style={back}>
          <span className="hint--bottom hint--rounded" aria-label="RGBA" style={index} ></span>
        ...
        <div className='grid-btn' onClick={this.props.dispGrid}>
          <span className="hint--bottom hint--rounded" aria-label="Grid" style={index} ></span>
      ...
      <div className='redo-button'>
        ...
        <div className='save' onClick={this.props.save}>
          <span className="hint--bottom hint--rounded" aria-label="Save" style={index} ></span>
        ...
        <div className='logout' onClick={this.props.userOut}>
          <span className="hint--bottom hint--rounded" aria-label="Logout" style={index} ></span>
        ...
        <div className='setting' id='setting' onClick={this.props.openSet}>
          <span className="hint--bottom hint--rounded" aria-label="Setting" style={index} ></span>
