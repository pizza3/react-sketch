    ...
    return(
      <div className='navigation'id='nav'>
        ...
        <div className='stroke-Box' onClick={this.props.chngStroke}>
          {this.state.stroke}
          <svg id='dropdown' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-down">
          <polyline points="6 9 12 15 18 9"></polyline>
        </svg>
        </div>
        <div className='grid-btn' onClick={this.props.dispGrid}>
          <svg id='grid-btn' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid">
        ...
        <div className='setting' id='setting' onClick={this.props.openSet}>
          <svg id='setting-logo' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings">
